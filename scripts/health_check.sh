...
# Check port
echo "2. Port 8765:"
if ssh -p 2222 -i ~/.ssh/id_ed25519_pi unitares-anima@192.168.1.165 \
  "lsof -i :8765 2>&1 | grep -q LISTEN"; then
...
# Check code imports
echo "3. Code:"
IMPORT_OUTPUT=$(ssh -p 2222 -i ~/.ssh/id_ed25519_pi unitares-anima@192.168.1.165 \
...
ERRORS=$(ssh -p 2222 -i ~/.ssh/id_ed25519_pi unitares-anima@192.168.1.165 \
...
# Check uptime
echo "5. Uptime:"
UPTIME=$(ssh -p 2222 -i ~/.ssh/id_ed25519_pi unitares-anima@192.168.1.165 \
