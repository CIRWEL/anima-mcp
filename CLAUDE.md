...
Or manually:
```bash
ssh unitares-anima@100.68.26.26 'cd ~/anima-mcp && git pull && sudo systemctl restart anima-broker anima'
```
...
| **Tailscale IPs** | Pi: `100.68.26.26`, Mac: `100.96.201.46`. These are stable. |
| **SSH to Pi** | Port 22 standard. If SSH times out/refused, try port 2222: `ssh -p 2222 -i ~/.ssh/id_ed25519_pi unitares-anima@100.68.26.26` (see `docs/operations/PI_ACCESS.md`). |
